FactoryGirl.define do
  factory :pwa, class: PersonWithAssociations do
    ...
    params do
      { first_name: 'Jakub', last_name: 'Kieszka', family_name: nil, lived: nil,
    ...
    factory :pwa_invalid do
      params do
        { first_name: 'Franciszka', last_name: 'Ciaputa', family_name: '',
    ...
    factory :pwa_without_dates do
      params do
        { first_name: nil, last_name: nil, family_name: nil, lived: nil,
